...
class DES:
    ...
    ] # S-boxes Substitution boxes (S-boxes)
    ...
    def __f(self, r, sub_key):
        ...
        # __permutate: (table, block)
        # _e Expansion table for turning 32 bit blocks into 48 bits (48)
...
if __name__ == '__main__':
    while True:
        try:
            ...
            if mode not in {1, 2}: raise Exception('Invalid mode!')
